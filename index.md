...
**2026/6:** [参赛注册表](http://uwsfh7orvljya407.mikecrm.com/6SGdfon)已发布！请参加竞赛的队员填写参赛注册表，我们将通过注册表中的邮箱针对后续结果提交和投稿等问题进行沟通。
{:.error}

**2026/6:** [评测细节](evaluation.html)已发布。
{:.success}

**2026/5:** [训练集和验证集](dataset.html)已发布，欢迎大家积极参赛！
{:.success}
